-- Add restaurant-level authorization check to categorize_bank_transaction
-- This prevents users from categorizing transactions for restaurants they don't have access to
