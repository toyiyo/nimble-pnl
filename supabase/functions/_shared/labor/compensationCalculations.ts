 ...
 */
export function getEmployeeSnapshotForDate<E extends LaborEmployee>(
  employee: E,
  targetDate: string | Date
): E {
...
export function validateCompensationFields(
  employee: Partial<LaborEmployee>
): string[] {
  const errors: string[] = [];
 ...
 */
export function requiresTimePunches(employee: LaborEmployee): boolean {
 ...
 * // Returns true
 */
export function isPerJobContractor(employee: LaborEmployee): boolean {
  return (
