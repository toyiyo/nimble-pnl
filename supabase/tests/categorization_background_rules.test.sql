...
--   c1a0...0a01 = Restaurant A  (tests a)
--   c1a0...0b01 = Restaurant B  (tests b, d)
--   c1a0...0c01 = Restaurant C  (tests c)
--   c1a0...0e01 = Restaurant E  (tests e, f)
-- Chart-of-accounts
--   c1a0...0f01/0f02 = rest A  (expense + cash)
--   c1a0...0f03      = rest B
--   c1a0...0f04      = rest C
--   c1a0...0f05      = rest E
-- Suppliers
--   c1a0...0d01 = Supplier A (SYGMA)
--   c1a0...0d02 = Supplier B
--   c1a0...0d03 = Supplier C
--   c1a0...0d04 = Supplier E
--   c1a0...0d05 = Supplier E-other (for test f)
-- Rules
--   c1a0...0001 = rule A (description+supplier)
--   c1a0...0002 = rule B supplier-only
--   c1a0...0003 = rule C supplier-only
--   c1a0...0004 = rule B supplier+debit (no description/amount)
--   c1a0...0005 = rule E (description+supplier)
-- Connected banks
--   c1a0...00ba = bank A
--   c1a0...00be = bank E
-- Transactions
--   c1a0...0101 = txn e01 (test e)
--   c1a0...0102 = txn e02 (test f)
