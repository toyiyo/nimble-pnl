...
cat <<'JSON'
{"systemMessage": "/dev workflow may be incomplete: progress.md is not marked '## Status: Complete' or 'Ready for merge'. Before treating this task as done, confirm Phase 8 (tests/typecheck/lint/build), Phase 8.5 (QA), and Phase 9d (review-comment triage) actually ran. Ref: .claude/skills/development-workflow/SKILL.md", "suppressOutput": true}
JSON
exit 0
