-- Fix process_unified_inventory_deduction parameter type to match trigger call
-- The trigger passes integer but function expects numeric, causing old version to be called

CREATE OR REPLACE FUNCTION public.process_unified_inventory_deduction(
    p_restaurant_id uuid,
    p_pos_item_name text,
    p_quantity_sold integer,  -- FIXED: Changed from numeric to integer
    p_sale_date text,
