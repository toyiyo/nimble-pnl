...
BEGIN
  ...
  -- entry_date is cast at UTC explicitly (bank_transactions.transaction_date
  -- is timestamptz, journal_entries.entry_date is date) to match the
  -- existing ledger, which was written under a UTC session TimeZone.
