...
VALUES
  ...
  ('00000000-0000-0000-0000-000000000602', :'restaurant_id', '2200', 'Sales Tax Payable', 'liability', 'sales_tax_payable', 'credit')
...
(If the project's `test:db` doesn't accept a single-file argument, run `npm run test:db` and confirm `36_monthly_sales_metrics_revenue_filter.sql` reports `ok 1..3`.)
