...
- Each bar represents one day's sales. Green bars are days you were **above** break-even; red bars are days you were **below**; a solid amber bar (no hatch) marks a completed day you landed **exactly at** break-even. This solid amber is distinct from today's amber *hatched* bar described below.
