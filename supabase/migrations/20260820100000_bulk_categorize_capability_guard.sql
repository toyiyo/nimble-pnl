-- Add a capability guard to bulk_categorize_bank_transactions.
--
...
-- (the only prior definition of this RPC), so this migration is the sole
-- provenance for the guard's own logic.
--
