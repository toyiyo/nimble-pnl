...
- [Manage Email Notifications](/help/notification-and-email-preferences) — Control which time-off events send emails and who receives them.  ·  `src/content/help/settings-and-integrations/notification-and-email-preferences.md`
