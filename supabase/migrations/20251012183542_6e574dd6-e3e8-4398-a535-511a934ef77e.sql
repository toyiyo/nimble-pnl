-- Update process_unified_inventory_deduction to accept numeric quantities instead of integer
CREATE OR REPLACE FUNCTION public.process_unified_inventory_deduction(
    p_restaurant_id uuid,
    p_pos_item_name text,
    p_quantity_sold numeric,  -- Changed from integer to numeric
    p_sale_date text,
...
-- Update bulk_process_historical_sales to pass numeric quantities without rounding
...
BEGIN
    ...
    LOOP
        BEGIN
            -- Process the sale with exact quantity (no rounding)
