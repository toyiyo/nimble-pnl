...
**Command:** `coderabbit review --agent --committed --base main`

Review loop (max 3 iterations):

```
Iteration 1: Run coderabbit review --agent --committed --base main
  |-- No actionable findings --> Proceed to Phase 8
  +-- Has findings --> Fix them, commit fixes
       |
       Iteration 2: Run coderabbit review --agent --committed --base main
         |-- No actionable findings --> Proceed to Phase 8
         +-- Has findings --> Fix them, commit fixes
              |
              Iteration 3: Run coderabbit review --agent --committed --base main
                |-- No actionable findings --> Proceed to Phase 8
...
| `--base <branch>` / `--base-commit <commit>` | Pin the comparison point. |
...
| 7c CodeRabbit | `coderabbit review --agent --committed --base main` | Never |
