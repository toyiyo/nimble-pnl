-- Update calculate_recipe_cost function to prioritize uom_purchase over size_unit
...
BEGIN
  ...
  LOOP
    ...
    BEGIN
      ...
      -- Handle bottle to ml conversion (when recipe uses bottle and purchase is in bottles)
      ELSIF recipe_unit_lower = 'bottle' AND actual_purchase_unit = 'bottle' THEN
        cost_per_purchase_unit := COALESCE(ingredient_record.cost_per_unit, 0);
        cost_impact := ingredient_record.quantity * cost_per_purchase_unit;
