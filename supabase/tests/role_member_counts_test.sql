...
INSERT INTO auth.users (id, email) VALUES
  ('d0000000-0000-0000-0000-000000000001', 'rmc-owner@example.test'),
  ('d0000000-0000-0000-0000-000000000002', 'rmc-legacy-manager-a@example.test'),
  ('d0000000-0000-0000-0000-000000000003', 'rmc-legacy-manager-b@example.test'),
  ('d0000000-0000-0000-0000-000000000004', 'rmc-explicit-manager@example.test'),
  ('d0000000-0000-0000-0000-000000000005', 'rmc-custom@example.test'),
  ('d0000000-0000-0000-0000-000000000006', 'rmc-custom-unresolved@example.test'),
  ('d0000000-0000-0000-0000-000000000007', 'rmc-other-restaurant-owner@example.test');

INSERT INTO public.restaurants (id, name) VALUES
  ('d0000000-0000-0000-0000-0000000000f1', 'Member Count Test Restaurant'),
  ('d0000000-0000-0000-0000-0000000000f2', 'Member Count Other Restaurant');

INSERT INTO public.roles (id, restaurant_id, name, flavor, builtin) VALUES
  ('d0000000-0000-0000-0000-0000000000c1', 'd0000000-0000-0000-0000-0000000000f1',
...
INSERT INTO public.user_restaurants (id, user_id, restaurant_id, role, role_id) VALUES
  ...
  ('d0000000-0000-0000-0000-000000000105', 'd0000000-0000-0000-0000-000000000005',
   'd0000000-0000-0000-0000-0000000000f1', 'collaborator_custom', 'd0000000-0000-0000-0000-0000000000c1'),
  ...
  ('d0000000-0000-0000-0000-000000000107', 'd0000000-0000-0000-0000-000000000007',
   'd0000000-0000-0000-0000-0000000000f2', 'owner', 'b0000000-0000-0000-0000-000000000001');
...
INSERT INTO public.user_restaurants (id, user_id, restaurant_id, role) VALUES
  ...
  ('d0000000-0000-0000-0000-000000000102', 'd0000000-0000-0000-0000-000000000002',
   'd0000000-0000-0000-0000-0000000000f1', 'manager'),
  ...
  ('d0000000-0000-0000-0000-000000000106', 'd0000000-0000-0000-0000-000000000006',
   'd0000000-0000-0000-0000-0000000000f1', 'collaborator_custom');
...
SELECT is(
  (SELECT count(*)::int FROM public.user_restaurants
     WHERE restaurant_id = 'd0000000-0000-0000-0000-0000000000f1'
...
SELECT is(
  (SELECT member_count::int FROM public.role_member_counts('d0000000-0000-0000-0000-0000000000f1')
...
SELECT is(
  (SELECT member_count::int FROM public.role_member_counts('d0000000-0000-0000-0000-0000000000f2')
     WHERE role_id = 'b0000000-0000-0000-0000-000000000001'),
  1,
...
SELECT is(
  (SELECT member_count::int FROM public.role_member_counts('d0000000-0000-0000-0000-0000000000f1')
     WHERE role_id = 'd0000000-0000-0000-0000-0000000000c1'),
  1,
...
-- ============================================================================
SELECT is(
  (SELECT count(*)::int FROM public.role_member_counts('d0000000-0000-0000-0000-0000000000f1')
...
SELECT is(
  (SELECT COALESCE(sum(member_count), 0)::int
     FROM public.role_member_counts('d0000000-0000-0000-0000-0000000000f1')),
  5,
...
SELECT is(
  (SELECT count(*)::int
     FROM public.role_member_counts('d0000000-0000-0000-0000-0000000000ff')),
  0,
