...
INSERT INTO chart_of_accounts (id, restaurant_id, account_name, account_code, account_type, account_subtype) VALUES
  ('test-coa-1', 'test-rest-1', 'Test Account', '5000', 'expense', 'cost_of_goods_sold')
...
INSERT INTO user_restaurants (user_id, restaurant_id, role) VALUES
  ('00000000-0000-0000-0000-000000000001', 'test-rest-1', 'owner')
ON CONFLICT (user_id, restaurant_id) DO UPDATE SET role = 'owner';

SELECT lives_ok(
  $$SELECT * FROM apply_rules_to_pos_sales('test-rest-1', 100)$$,
...
SELECT lives_ok(
  $$SELECT * FROM apply_rules_to_bank_transactions('test-rest-1', 100)$$,
