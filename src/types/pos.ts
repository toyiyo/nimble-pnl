...
export type POSSystemType = 'square' | 'toast' | 'clover' | 'resy' | 'shift4' | 'revel' | 'focus' | 'manual' | 'manual_upload';
...
export interface UnifiedSaleItem {
  ...
  item_type?: 'sale' | 'tip' | 'tax' | 'discount' | 'comp' | 'service_charge' | 'refund' | 'other';
