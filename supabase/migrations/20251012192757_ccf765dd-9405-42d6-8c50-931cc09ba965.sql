-- Enhanced inventory deduction with conversion warnings
-- Phase 1: Add conversion warnings to process_unified_inventory_deduction function
...
BEGIN
    ...
    LOOP
        ...
        -- ENHANCED: Track fallback usage and add warning
        ...
        -- ENHANCED: Build better reason text with conversion method indicator
