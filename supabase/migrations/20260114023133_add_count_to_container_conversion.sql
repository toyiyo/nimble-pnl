-- Add count-to-container unit conversion for inventory deduction
-- This handles products stored in packages with countable items (tortillas, buns, etc.)
-- Example: 1 tortilla (each) from 50-per-bag → 0.02 bags
...
BEGIN
    ...
    LOOP
        ...
        -- CASE 1: Count-to-Container Conversion (NEW)
