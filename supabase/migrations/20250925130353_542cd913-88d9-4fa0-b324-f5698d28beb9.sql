-- Create a function to sync Square data to unified sales
...
BEGIN
  ...
  SELECT 
    ...
    CASE 
      WHEN soli.base_price_money IS NOT NULL THEN soli.base_price_money / 100.0 
      ELSE NULL 
    END as unit_price,
    CASE 
      WHEN soli.total_money IS NOT NULL THEN soli.total_money / 100.0 
      ELSE NULL 
    END as total_price,
