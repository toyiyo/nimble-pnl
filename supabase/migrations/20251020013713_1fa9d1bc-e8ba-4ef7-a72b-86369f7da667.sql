-- Fix invalid enum value in categorize_bank_transaction
-- Remove the incorrect status = 'categorized' line since is_categorized already tracks this
...
BEGIN
  ...
  -- Update transaction - removed invalid status = 'categorized' 
