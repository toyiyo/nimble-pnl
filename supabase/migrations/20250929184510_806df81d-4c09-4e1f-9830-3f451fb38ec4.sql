-- Fix rice and other product-specific conversions in simulate_inventory_deduction
...
BEGIN
  ...
  LOOP
    ...
    ELSE
      -- Different units: use conversion factor (e.g., 750 ml recipe / 750 = 1 bottle purchase)
