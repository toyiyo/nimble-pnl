-- Update sync_square_to_unified_sales to preserve time information from Square
...
BEGIN
  ...
  SELECT 
    ...
    -- Extract time from closed_at in restaurant's local timezone
    (so.closed_at AT TIME ZONE 'UTC' AT TIME ZONE v_restaurant_timezone)::time as sale_time,
