...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      schedule_slots: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "schedule_slots_restaurant_id_fkey"
            columns: ["restaurant_id"]
            isOneToOne: false
            referencedRelation: "restaurants"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "schedule_slots_shift_id_fkey"
            columns: ["shift_id"]
            isOneToOne: false
            referencedRelation: "shifts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "schedule_slots_week_template_slot_id_fkey"
            columns: ["week_template_slot_id"]
            isOneToOne: false
            referencedRelation: "week_template_slots"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      week_template_slots: {
        ...
        Relationships: [
          {
            foreignKeyName: "week_template_slots_shift_template_id_fkey"
          ...
          {
            foreignKeyName: "week_template_slots_week_template_id_fkey"
      ...
      week_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "week_templates_restaurant_id_fkey"
            columns: ["restaurant_id"]
            isOneToOne: false
            referencedRelation: "restaurants"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      delete_generated_schedule: {
        Args: { p_restaurant_id: string; p_week_start_date: string }
        Returns: Json
      }
      delete_shift_series: {
        Args: {
