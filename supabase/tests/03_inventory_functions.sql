...
-- Test process_inventory_deduction function exists
SELECT has_function(
    'public',
...
-- Test upsert_product_supplier function exists
SELECT has_function(
    'public',
    'upsert_product_supplier',
    ARRAY['uuid', 'uuid', 'text', 'numeric', 'boolean'],
    'upsert_product_supplier function should exist'
);
...
SELECT function_returns(
    ...
    ARRAY['uuid', 'uuid', 'text', 'numeric', 'boolean'],
    'uuid',
    'upsert_product_supplier should return uuid'
);

-- Test set_preferred_product_supplier function exists
SELECT has_function(
    'public',
