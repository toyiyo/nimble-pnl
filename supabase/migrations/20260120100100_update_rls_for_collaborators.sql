...
-- ============================================================================
-- inventory_transactions and inventory_transactions_ITEMS TABLES
-- Collaborator access: collaborator_inventory only
-- ============================================================================
...
ON public.inventory_transactions
FOR SELECT
USING (user_has_capability(restaurant_id, 'view:inventory_transactions'));

CREATE POLICY "Users can insert inventory_transactions for their restaurants"
ON public.inventory_transactions
FOR INSERT
WITH CHECK (user_has_capability(restaurant_id, 'edit:inventory_transactions'));

CREATE POLICY "Users can update inventory_transactions for their restaurants"
ON public.inventory_transactions
FOR UPDATE
USING (user_has_capability(restaurant_id, 'edit:inventory_transactions'));
