-- Refactor process_unified_inventory_deduction to be domain-driven
-- Remove all container type assumptions ('bottle', 'bag', 'box')
-- Base logic purely on unit domains (volume vs weight)
